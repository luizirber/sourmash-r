...
[![Build Status](https://travis-ci.com/luizirber/sourmash-r.svg)](https://travis-ci.com/luizirber/sourmash-r)
[![AppVeyor Build Status](https://ci.appveyor.com/api/projects/status/github/luizirber/sourmash-r)](https://ci.appveyor.com/project/luizirber/sourmash-r)

> An experiment on wrapping sourmash Rust code and calling it in R
...
This example is based on the [hellorust](https://github.com/r-rust/hellorust) example project.
...
├─ src
│  ├─ sourmash          ← git submodule with dib-lab/sourmash content
│  │  ├─ Cargo.toml     ← cargo dependencies and metadata
│  │  ├─ src            ← rust source code
│  │  └─ include
│  │     └─ sourmash.h  ← C headers for exported rust API
